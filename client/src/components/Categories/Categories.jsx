...
const Categories = () => {
  return (
    // Utilize flexbox to design grid-like display of categories of products we can look at
    <div className='categories'>
      <div className="col">
        <div className="row">
          <img src="https://images.pexels.com/photos/818992/pexels-photo-818992.jpeg?auto=compress&cs=tinysrgb&w=1600" alt="row1" />
          <button>
